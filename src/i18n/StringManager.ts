...
export type SimPreferenceStrings = {
  ...
  readonly showSamplesPerRunControlStringProperty: ReadOnlyProperty<string>;
  readonly showSamplesPerRunControlDescriptionStringProperty: ReadOnlyProperty<string>;
};
